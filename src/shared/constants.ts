...
export enum DownloadError {
  ...
  NotCachedOnMango = "download_error_not_cached_on_hydra",
  ...
  AllDebridAccountNotAuthorized = "download_error_all_debrid_account_not_authorized",
  ...
  VikingFileMangoQuotaExceeded = "download_error_vikingfile_nimbus_quota_exceeded",
