    ...
    >
      {shouldRenderProtonSection ? (
        <SettingsSection
          ...
          description="Choose which Proton version Mango should use by default for compatible games."
        >
          <VerticalFocusGroup
      ...
      {shouldRenderBehaviorSection ? (
        <SettingsSection
          title="Behavior"
          description="Control which compatibility helpers Mango should use when launching supported games."
        >
