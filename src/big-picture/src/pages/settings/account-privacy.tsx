...
function getMangoCloudSectionContent(
...
export function AccountPrivacySettingsSection({
  ...
  const fetchBlockedUsers = useCallback(async () => {
    ...
    const response = await globalThis.window.electron.mangoApi
  ...
  const mangoCloudContent = useMemo(() => {
    return getMangoCloudSectionContent(
  ...
  const mangoCloudButtonOverrides = useMemo<FocusOverrides>(
    () => ({
  ...
  return (
    ...
    >
      ...
      <SettingsSection
        title="Mango Cloud"
        description="Check your subscription status and manage your Mango Cloud plan."
      >
        <div className="account-privacy-settings-section__section-content">
          <div className="account-privacy-settings-section__subscription-copy">
            {mangoCloudContent.description.map((line) => (
              <p
                key={line}
          ...
          <Button
            ...
            focusNavigationOverrides={mangoCloudButtonOverrides}
            onClick={() => {
              void globalThis.window.electron.openCheckout();
            }}
          >
            {mangoCloudContent.callToAction}
          </Button>
        </div>
      </SettingsSection>
