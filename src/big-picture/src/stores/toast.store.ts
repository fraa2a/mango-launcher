...
export type BigPictureToastFallbackVisual = "mango" | "settings" | "downloads";
...
export const useBigPictureToastStore = create<BigPictureToastState>((set) => ({
  ...
  showToast: (toast) => {
    set((state) => ({
      ...
      color: toast.color,
      fallbackVisual: toast.fallbackVisual ?? "mango",
  ...
  showSuccessToast: (title, options) => {
    set((state) => ({
      ...
      color: options?.color,
      fallbackVisual: options?.fallbackVisual ?? "mango",
