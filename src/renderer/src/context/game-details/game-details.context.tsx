...
export function GameDetailsContextProvider({
  ...
  useEffect(() => {
    ...
    window.addEventListener("mango:openRepacks", handler as EventListener);

    return () => {
      window.removeEventListener("mango:openRepacks", handler as EventListener);
    };
  }, [objectId]);
  ...
  useEffect(() => {
    ...
    window.addEventListener("mango:openGameOptions", handler as EventListener);

    return () => {
      window.removeEventListener(
        "mango:openGameOptions",
  ...
  useEffect(() => {
    ...
    const fetchDownloadSources = async () => {
      try {
        ...
        const downloads = await window.electron.mangoApi.get<GameRepack[]>(
