...
export function SettingsRetroAchievements() {
  ...
  useEffect(() => {
    ...
    globalThis.window.electron.mangoApi
  ...
  const handleConnect: React.FormEventHandler<HTMLFormElement> = async (
    ...
    try {
      const status =
        await globalThis.window.electron.mangoApi.post<RetroAchievementsIntegration>(
  ...
  const handleRefresh = async () => {
    ...
    try {
      const status =
        await globalThis.window.electron.mangoApi.get<RetroAchievementsIntegration>(
