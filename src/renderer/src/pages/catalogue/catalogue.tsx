...
export default function Catalogue() {
  ...
  const debouncedSearch = useRef(
    debounce(
      async (
        ...
        try {
          const response = await window.electron.mangoApi.post<{
  ...
  const sortOptions = useMemo(
    () => [
      ...
      {
        key: "mangoScore:desc",
        value: "mangoScore:desc",
        label: t("sort_highest_rating"),
      },
      {
        key: "mangoScore:asc",
        value: "mangoScore:asc",
        ...
        <div className="catalogue__filters-container">
          <div className="catalogue__filters-sections">
            ...
            <Button
              type="button"
              theme="dark"
              className="catalogue__surprise-button catalogue__surprise-button--sidebar"
              onClick={handleRandomizerClick}
              disabled={!randomGame}
            >
              <span className="catalogue__surprise-icon">
                <img src={starsIconAnimated} alt="" />
              </span>
              {t("surprise_me")}
            </Button>
