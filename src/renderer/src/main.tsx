...
Sentry.init({
  ...
  release: "mango-launcher@" + (await globalThis.electron.getVersion()),
});
...
// for all routes) so detached windows — game-launcher, big-picture, etc. —
// react too, not just the routes mounted under <App />.
