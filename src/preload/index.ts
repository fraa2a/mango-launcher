...
contextBridge.exposeInMainWorld("electron", {
  ...
  toggleGameWined3d: (shop: GameShop, objectId: string, useWined3d: boolean) =>
    ipcRenderer.invoke("toggleGameWined3d", shop, objectId, useWined3d),
  toggleGameNativeWayland: (
    shop: GameShop,
    objectId: string,
  ...
  autoDetectSteamArtwork: (
    executablePath: string,
    gameObjectId: string
  ): Promise<{ appId: string | null; headerPath: string | null }> =>
    ipcRenderer.invoke("autoDetectSteamArtwork", executablePath, gameObjectId),
  copyCustomGameAsset: (
    sourcePath: string,
  ...
  mangoApi: {
    get: (
      ...
      ipcRenderer.invoke("mangoApiCall", {
        method: "get",
        url,
  ...
  installMangoDeckyPlugin: () => ipcRenderer.invoke("installMangoDeckyPlugin"),
  getMangoDeckyPluginInfo: () => ipcRenderer.invoke("getMangoDeckyPluginInfo"),
